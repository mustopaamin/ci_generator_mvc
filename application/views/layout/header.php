...
<html>
  <head>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo base_url();?>asset/ionicons/ionicons.min.css">
    <!-- JQueryUI -->
	<link href="<?= base_url();?>asset/plugins/jQueryUI/jquery-ui-1.10.4.custom.min.css" rel="stylesheet">
    <!-- Theme style -->
	...
	<script src="<?= base_url();?>asset/plugins/jQueryUI/jquery-ui-1.10.4.custom.min.js"></script>
    <!-- Bootstrap 3.3.5 -->
